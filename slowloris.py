...
parser.add_argument('-s', '--sockets', default=250, help="Number of sockets to use in the test", type=int)
...
parser.add_argument('-t', '--tor', dest="tor", action="store_true", help="Send over tor (socks5)")
